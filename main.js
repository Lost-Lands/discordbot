        ...
        if (command === 'ping') {
            ...
            const helpEmbed = new Discord.MessageEmbed()
                ...
                .addFields(
                    ...
                    { name: '**Player info:**', value: '`-player {name}`'},
                    { name: '**Eat?**', value: '`-eat`'},
                )
                .setTimestamp()
                    ...
                    if (error) {
                        ...
                        if (message.guild.id !== admin_guild) {
                            ...
                            playerEmbed.addFields(
                                ...
                                { name: '**Last Geolocation**', value: location, inline: true },
                            )
                                ...
                                c.get(essentialsPath, function(err, stream) {
                                    if (err) {
                                        ...
                                        stream.on('end', function() {
                                            ...
                                            playerEmbed.addFields(
                                                { name: '**Logout Location**', value: logoutLocation, inline: true },
                                                { name: '**Last Location**', value: lastLocation, inline: true },
                                                { name: '**Last Recorded Username**', value: essentials.lastAccountName , inline: true },
                                            )
